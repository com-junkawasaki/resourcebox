 ...
 * @internal
 */
function buildPropertyTermDefinition(propMeta: PropertyMeta): JsonLdContextValue {
  const termDef: Record<string, string> = {
  ...
  return termDef as unknown as JsonLdContextValue;
}
